      ...
      <div className="container-encuestas-create">
        <div className="c-encuestas-create-1">
          <form className="c-encuestas-create-form" onSubmit={guardarencuesta}>
            ...
            <input
              className="encuestas-input3"
              type="file"
              onChange={handleFileInput}
            />
            <br /> <br /> <br />
            <button className="encuestas-create-boton1" type="submit">
              Guardar
            </button>
            <button className="encuestas-create-boton2" type="reset">
              Limpiar
            </button>
          </form>
        </div>
