...
function SeccionCreate() {
  ...
  const guardarseccion = async (event) => {
    ...
    await axios.post(URL_SERVIDOR + "/secciones", data).then((response) => {
      ...
      <div className="container-secciones-create">
        <div className="c-secciones-create-1">
          <form className="c-secciones-create-form" onSubmit={guardarseccion}>
            ...
            <br />
            <br />
            <button className="secciones-create-boton1" type="submit">
              Guardar
            </button>
            <button className="secciones-create-boton2" type="reset">
              Limpiar
            </button>
          </form>
        </div>
