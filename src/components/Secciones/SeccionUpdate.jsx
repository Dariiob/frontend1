...
function SeccionUpdate() {
  ...
  const putseccion = async (event) => {
    ...
    const data = {
      nombre: `${
        form.nombre.value === "" ? seccion.nombre : form.nombre.value
      }`,
      id_encuesta: `${
        form.id_encuesta.value === ""
          ? seccion.id_encuesta
          : form.id_encuesta.value
      }`,
    };
    ...
    await axios
      .put(URL_SERVIDOR + `/secciones/${seccion.id}`, data)
      .then((response) => {
        console.log(response.data);
      });
      ...
      <div className="container-secciones-edit">
        ...
        <div className="c-secciones-edit-form-1">
          <form className="c-secciones-edit-form" onSubmit={putseccion}>
            ...
            <input
              className="secciones-edit-input1"
              type="text"
            ...
            <button className="secciones-edit-boton1" type="submit">
              Guardar
            </button>
            <button className="secciones-edit-boton2" type="reset">
              Limpiar
            </button>
          </form>
        </div>
