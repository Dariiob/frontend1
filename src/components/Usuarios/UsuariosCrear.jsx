      ...
      <div className="container-usuarios-create">
        <div className="c-usuarios-create-1">
          <form className="c-usuarios-create-form" onSubmit={guardarUsuario}>
            ...
            <input
              className="usuarios-input3"
              type="password"
              placeholder="Contrasenia"
              name="Contraseña"
            ></input>
            <br /> <br /> <br />
            <button className="usuarios-create-boton1" type="submit">
              Guardar
            </button>
            <button className="usuarios-create-boton2" type="reset">
              Limpiar
            </button>
          </form>
        </div>
