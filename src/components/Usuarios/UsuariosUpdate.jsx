...
function UsuariosUpdate() {
  ...
  const putUser = async (event) => {
    ...
    const data = {
      Nombre: `${
        form.Nombre.value === "" ? usuario.nombre : form.Nombre.value
      }`,
      Correo: `${
        form.Correo.value === "" ? usuario.correo : form.Correo.value
      }`,
      Contraseña: `${
    ...
    await axios
      .put(URL_SERVIDOR + `/usuario/${usuario.id}`, data)
      .then((response) => {
      ...
      <div className="container-usuarios-edit">
        <div className="c-usuarios-edit-form-1">
          <form className="c-usuarios-edit-form" onSubmit={putUser}>
            ...
            <input
              className="usuarios-edit-input1"
              type="text"
            ...
            <button className="usuarios-edit-boton1" type="submit">
              Guardar
            </button>
            <button className="usuarios-edit-boton1" type="reset">
              Limpiar
            </button>
          </form>
        </div>
